...
class Boss(BaseModel):
    ...
    # 是否使用收藏的
    use_collect: bool = Field(default=False)

    # 没有开启极是否拉到60级进行攻打
    attack_60: bool = Field(default=False, title='没有开启极是否拉到60级进行攻打')
