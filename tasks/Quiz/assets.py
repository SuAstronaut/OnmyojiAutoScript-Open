...
class QuizAssets: 
	...
	# Image Rule Assets
	# description 
	I_ENTRY = RuleImage(file="quiz/quiz_entry.png", roi_front=(143,363,40,128), roi_back=(119,246,100,326), threshold=0.8, method="Template matching", path="./tasks/Quiz/")
	# 开始 
	I_START = RuleImage(file="quiz/quiz_start.png", roi_front=(1149,608,66,41), roi_back=(1136,574,100,100), threshold=0.8, method="Template matching", path="./tasks/Quiz/")
	# 标志 
	I_MESSAGE = RuleImage(file="quiz/quiz_message.png", roi_front=(75,488,58,41), roi_back=(50,460,100,100), threshold=0.8, method="Template matching", path="./tasks/Quiz/")
	# 失败然后离开 
	I_FAIL_QUIT = RuleImage(file="quiz/quiz_fail_quit.png", roi_front=(416,529,183,45), roi_back=(354,502,275,100), threshold=0.8, method="Template matching", path="./tasks/Quiz/")
	# 结算分享 
	I_SHARE = RuleImage(file="quiz/quiz_share.png", roi_front=(1171,625,53,44), roi_back=(1152,592,100,100), threshold=0.8, method="Template matching", path="./tasks/Quiz/")
