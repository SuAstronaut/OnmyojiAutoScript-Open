...
class SecretConfig(BaseModel):
    secret_gold_50: bool = Field(default=False, description='secret_gold_50_help')
    secret_gold_100: bool = Field(default=False, description='secret_gold_100_help')
    layer_10: bool = Field(default=False, description='layer_10_help')
    layer_9: bool = Field(default=False)
